...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Koran</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Koran</button>
<br/>
<br/>

<?php 
$periksa=mysql_query("select * from barang where jumlah <=5");
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-2">Nama Koran</th>
		<th class="col-md-2">Modal Koran</th>
		<th class="col-md-2">Harga Koran</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Koran Baru</h4>
			</div>
			<div class="modal-body">
				<form action="tmb_brg_act.php" method="post">
					<div class="form-group">
						<label>Nama Koran</label>
						<input name="nama" type="text" class="form-control" placeholder="Nama Koran ..">
					</div>
					<div class="form-group">
						<label>Jenis</label>
						<input name="jenis" type="text" class="form-control" placeholder="Jenis Koran ..">
					</div>
					<div class="form-group">
						<label>Pemesan</label>
						<input name="suplier" type="text" class="form-control" placeholder="Pemesan ..">
					</div>
					<div class="form-group">
