...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'www.dumaipos.co email : dumaipos123@yahoo.com',0,'L');
...
$pdf->Cell(0,0.7,'Laporan Data Penjualan Koran',0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(6, 0.8, 'Nama Koran', 1, 0, 'C');
...
$pdf->Cell(4, 0.8, 'Diketahui Oleh', 0, 0, 'C');
$pdf->Cell(-4, 5.8, 'Manager Pemasaran', 0, 0, 'C');
